...
async function mintCertificate() {
  try {
    ...
    form.append("description", "Awarded for demonstrating mastery in React advanced patterns.");
    ...
    console.log("✅ Mint Certificate Response:", JSON.stringify(response.data, null, 2));
  } catch (error) {
